...
**Attack vector (target the weakest loop):** <br>Preference Loop (2/5): The AI Assistant has limited long-term memory of user and team preferences, making it relatively easy for users to switch to a more personalized AI experience without losing much accumulated value.
